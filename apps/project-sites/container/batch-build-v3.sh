#!/bin/bash
# Batch build v3 — improved prompts: dark theme, SVG illustrations, no white sections, proper icons
...
dispatch_and_wait() {
  ...
  echo "  Done: https://${slug}.projectsites.dev"
}

# 1. Nobu (Restaurant)
dispatch_and_wait "nobu-v4" '{
  "slug":"nobu-v4","siteId":"cat-restaurant-v4","businessName":"Nobu Restaurant",
  "businessWebsite":"https://www.noburestaurants.com",
  "additionalContext":"Upscale Japanese fusion restaurant by Chef Nobu Matsuhisa. Black Cod Miso, yellowtail sashimi with jalapeño. 50+ locations. Robert De Niro co-owner.",
  "researchData":{"profile":{"business_type":"Restaurant / Café","business_name":"Nobu Restaurant","description":"World-renowned Japanese-Peruvian fusion restaurant founded by Chef Nobuyuki Matsuhisa.","established_year":1994,"address":"195 Broadway, New York, NY 10007","phone":"(212) 219-0500","email":"reservations@noburestaurants.com","services":[{"name":"Fine Dining","description":"Multi-course omakase and à la carte","price":"$$$"},{"name":"Private Events","description":"Exclusive private dining rooms"},{"name":"Bar & Lounge","description":"Craft cocktails with Japanese ingredients"},{"name":"Takeout","description":"Signature dishes for pickup"}],"hours":[{"day":"Mon-Thu","open":"5:00 PM","close":"11:00 PM"},{"day":"Fri-Sat","open":"5:00 PM","close":"12:00 AM"},{"day":"Sunday","open":"5:00 PM","close":"10:00 PM"}]},"brand":{"primary_color":"#1a1a1a","secondary_color":"#c9a96e","accent_color":"#d4af37","heading_font":"Playfair Display","body_font":"Lato","style_notes":"Elegant, minimalist Japanese aesthetic. Dark backgrounds with gold accents."},"sellingPoints":{"selling_points":[{"headline":"World-Famous Black Cod Miso","description":"The signature dish — buttery miso-marinated black cod, slow-roasted to perfection."},{"headline":"Celebrity Chef Founded","description":"Founded by Chef Nobu Matsuhisa with Robert De Niro. 50+ locations across 5 continents."},{"headline":"Japanese-Peruvian Fusion","description":"A unique culinary tradition blending umami-rich Japanese technique with bold South American flavors."}],"hero_slogans":["Where East Meets South America","The Art of Japanese-Peruvian Cuisine"]},"social":{"website_url":"https://www.noburestaurants.com","social_links":[{"platform":"Instagram","url":"https://instagram.com/noburestaurants"},{"platform":"Facebook","url":"https://facebook.com/noburestaurants"}]},"images":{}},
  "assetUrls":[]
}' "cat-restaurant-v4"

# 2. Vito's (Salon)
dispatch_and_wait "vitos-salon-v3" '{
  "slug":"vitos-salon-v3","siteId":"cat-salon-v3","businessName":"Vitos Mens Salon",
  "additionalContext":"Traditional Italian-style mens barbershop in Lake Hiawatha, NJ. Hot towel shaves, precision cuts, beard grooming.",
  "researchData":{"profile":{"business_type":"Salon / Barbershop","business_name":"Vitos Mens Salon","description":"Premium mens grooming with traditional barbering and modern style.","address":"74 N Beverwyck Rd, Lake Hiawatha, NJ 07034","phone":"(973) 335-8211","services":[{"name":"Classic Haircut","description":"Precision cut with hot towel, scalp massage","price":"$25"},{"name":"Hot Towel Shave","description":"Traditional straight razor shave","price":"$30"},{"name":"Beard Trim","description":"Expert beard sculpting","price":"$15"},{"name":"Hair & Beard Combo","description":"Full haircut with beard trim","price":"$35"},{"name":"Kids Haircut","description":"Children 12 and under","price":"$18"}],"hours":[{"day":"Monday","open":"Closed","close":"Closed"},{"day":"Tue-Fri","open":"9:00 AM","close":"7:00 PM"},{"day":"Saturday","open":"8:00 AM","close":"5:00 PM"},{"day":"Sunday","open":"Closed","close":"Closed"}]},"brand":{"primary_color":"#1c1c1c","secondary_color":"#8b7355","accent_color":"#c9a96e","heading_font":"Cormorant Garamond","body_font":"Montserrat","style_notes":"Classic barbershop meets modern luxury. Dark tones, gold/copper accents."},"sellingPoints":{"selling_points":[{"headline":"Old-School Craft, Modern Style","description":"Traditional Italian barbering perfected over decades."},{"headline":"The Hot Towel Experience","description":"Every visit includes a signature hot towel treatment."},{"headline":"Your Neighborhood Barber","description":"Serving Lake Hiawatha and Morris County. Where regulars become family."}],"hero_slogans":["Where Every Cut Tells Your Story","Classic Barbering, Modern Gentleman"]},"social":{"social_links":[]},"images":{}},
  "assetUrls":[]
}' "cat-salon-v3"

# 3. Cravath (Legal)
dispatch_and_wait "cravath-v3" '{
  "slug":"cravath-v3","siteId":"cat-legal-v3","businessName":"Cravath, Swaine & Moore LLP",
  "businessWebsite":"https://www.cravath.com",
  "additionalContext":"One of the most prestigious law firms. Pioneer of the Cravath System. Founded 1819. M&A, corporate law, litigation.",
...
# 4. Mayo Clinic (Medical)
dispatch_and_wait "mayo-clinic-v3" '{
  "slug":"mayo-clinic-v3","siteId":"cat-medical-v3","businessName":"Mayo Clinic",
...
# 5. Linear (Tech)
dispatch_and_wait "linear-v3" '{
  "slug":"linear-v3","siteId":"cat-tech-v3","businessName":"Linear",
...
# 6. Equinox (Fitness)
dispatch_and_wait "equinox-v3" '{
  "slug":"equinox-v3","siteId":"cat-fitness-v3","businessName":"Equinox",
...
# 7. Compass (Real Estate)
dispatch_and_wait "compass-v3" '{
  "slug":"compass-v3","siteId":"cat-realestate-v3","businessName":"Compass",
...
dispatch_and_wait "suffolk-v3" '{
  "slug":"suffolk-v3","siteId":"cat-construction-v3","businessName":"Suffolk Construction",
  "businessWebsite":"https://www.suffolk.com",
  "additionalContext":"One of the largest general building contractors. $5B+ revenue. Construction tech innovator.",
...
dispatch_and_wait "annie-leibovitz-v3" '{
  "slug":"annie-leibovitz-v3","siteId":"cat-photo-v3","businessName":"Annie Leibovitz Studio",
...
# 10. White House (Other)
dispatch_and_wait "the-white-house-v5" '{
  "slug":"the-white-house-v5","siteId":"cat-other-v5","businessName":"The White House",
  "businessWebsite":"https://www.whitehouse.gov",
  "additionalContext":"Official residence of the President. 1600 Pennsylvania Avenue. 132 rooms, 35 bathrooms, 6 levels, 412 doors.",
