...
export const securityHeadersMiddleware: MiddlewareHandler<{
  ...
  c.header(
    ...
    [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' https://unpkg.com https://releases.transloadit.com https://js.stripe.com https://us.i.posthog.com https://static.cloudflareinsights.com",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://releases.transloadit.com",
      "img-src 'self' data: https:",
      "font-src 'self' https://fonts.gstatic.com",
      "connect-src 'self' https://api.stripe.com https://lottie.host https://us.i.posthog.com https://unpkg.com https://releases.transloadit.com",
      'frame-src https://js.stripe.com https://lottie.host',
      "object-src 'none'",
      "base-uri 'self'",
    ].join('; '),
  );
